...
See the files [README-ruby.md](https://github.com/ripienaar/puppet-mcollective/blob/master/example/web_deploy/README-ruby.md) and [README-puppet.md](https://github.com/ripienaar/puppet-mcollective/blob/master/example/web_deploy/README-puppet.md) for a walkthrough of the
